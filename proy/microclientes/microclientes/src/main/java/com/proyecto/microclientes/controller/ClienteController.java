...
public class ClienteController {
    ...
    public ResponseEntity<ClienteDTO> actualizarParcial(@PathVariable String clienteid, @RequestBody Map<String, Object> updates) {
        ClienteDTO clienteActualizado = service.actualizarParcial(clienteid, updates);
        return ResponseEntity.ok(clienteActualizado);
    }
